...
namespace CL
{
	...
	//template<class listItem> ListIterator<listItem>& operator++(ListIterator<listItem>& it)
	//template<class listItem> listItem& operator*(ListIterator<listItem>& it)
	...
	public:
		...
		{
			ListNode<listItem>* node = new ListNode<listItem>();
			node->item = item;
		...
		ListIterator<listItem> insert(ListIterator<listItem> iterator, listItem item)
		{
			...
			ListNode<listItem>* node = new ListNode<listItem>(item); 
